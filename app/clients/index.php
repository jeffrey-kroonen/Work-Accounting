            ...
            <div class="card-content">
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr class="text-muted">
                    <td><?= $client->name; ?></td>
                    <td class="text-right"><a href="/clients/client.php?id=<?= $client->id; ?>" class="text-muted"><i class="far fa-edit mr-2"></i></a><i class="fas fa-trash delete-client" data-id="<?= $client->id; ?>"></i></td>
                  </tr>
                  <?php
                      }
                    }
